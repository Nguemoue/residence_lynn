...
<main id="maincontent" role="main">
	...
	<?php if( get_theme_mod( 'vw_construction_estate_slider_hide_show', false) == 1 || get_theme_mod( 'vw_construction_estate_resp_slider_hide_show', true) == 1) { ?>
					            ...
					            <div class="carousel-caption">
					              <div class="inner_carousel">
						            ...
						            <div class="more-btn wow slideInLeft delay-1000" data-wow-duration="2s">
			                          <?php if ( get_theme_mod('vw_construction_estate_banner_button_label','DISCOVER MORE') != '' ) {?>
			                            <div class ="more-btn mt-md-4 mt-0">
			                              <a class="px-4 px-lg-4 px-md-4 py-3 py-lg-3 py-md-3" href="<?php echo esc_url(get_theme_mod('vw_construction_estate_top_button_url',false));?>"><?php echo esc_html(get_theme_mod('vw_construction_estate_banner_button_label','DISCOVER MORE'));?><span class="screen-reader-text"><?php esc_html_e( 'DISCOVER MORE','vw-construction-estate');?></span></a>
			                            </div>
			                          <?php }?>
			                        </div>
					              </div>

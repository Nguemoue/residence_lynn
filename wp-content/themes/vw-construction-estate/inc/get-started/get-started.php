    ...
    <div class="col-right coupen-section">
		...
		<div class="logo-right">			
			<div class="update-now">
				<h4><?php esc_html_e('Try Premium ','vw-construction-estate'); ?></h4>
				<h4><?php esc_html_e('VW Construction Estate Theme','vw-construction-estate'); ?></h4>
				<h4 class="disc-text"><?php esc_html_e('at 20% Discount','vw-construction-estate'); ?></h4>
    ...
    <div class="tab-sec">
		<div class="tab">
			<button class="tablinks" onclick="vw_construction_estate_open_tab(event, 'lite_theme')"><?php esc_html_e( 'Setup With Customizer', 'vw-construction-estate' ); ?></button>
		  	...
		  	<button class="tablinks" onclick="vw_construction_estate_open_tab(event, 'get_bundle')"><?php esc_html_e( 'Get 250+ Themes Bundle at $99', 'vw-construction-estate' ); ?></button>
		</div>
		...
		<div id="theme_pro" class="tabcontent">
		    ...
		    <div class="col-right-pro">
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_CONSTRUCTION_ESTATE_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get 250+ Themes Bundle at $99', 'vw-construction-estate'); ?></a>
				</div>
		   ...
		   <div class="col-left-pro">
		   	<h3><?php esc_html_e( 'WP Theme Bundle', 'vw-construction-estate' ); ?></h3>
		    	...
		    	<div class="feature">
		    		...
		    		<p><?php esc_html_e('250+ Premium Themes & 5+ Plugins.', 'vw-construction-estate'); ?></p>

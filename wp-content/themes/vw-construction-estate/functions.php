...
function vw_construction_estate_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/premium-construction-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-construction-estate' ) .'</a></span>';
		echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'THEME BUNDLE', 'vw-construction-estate' ) .'</a></span>';
	echo '</div>';
}
...
if (!function_exists('vw_construction_estate_edit_link')) :

    function vw_construction_estate_edit_link($view = 'default')
    {
        global $post;
            edit_post_link(
                sprintf(
                    ...
                    /* translators: %s: Name of current post. Only visible to screen readers */
                        __('Edit <span class="screen-reader-text">%s</span>', 'vw-construction-estate'),
                        array(
                            'span' => array(
                                'class' => array(),
                            ),
...
function vw_construction_estate_init_setup() {

	define('VW_CONSTRUCTION_ESTATE_FREE_THEME_DOC',__('https://preview.vwthemesdemo.com/docs/free-vw-construction-estate/','vw-construction-estate'));
	...
	define('VW_CONSTRUCTION_ESTATE_BUY_NOW',__('https://www.vwthemes.com/products/premium-construction-wordpress-theme','vw-construction-estate'));
	define('VW_CONSTRUCTION_ESTATE_LIVE_DEMO',__('https://vwthemes.net/vw-construction-estate-pro/','vw-construction-estate'));
	define('VW_CONSTRUCTION_ESTATE_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/vw-construction-estate-pro/','vw-construction-estate'));
	...
	define('VW_CONSTRUCTION_ESTATE_CREDIT',__('https://www.vwthemes.com/products/free-construction-wordpress-theme','vw-construction-estate'));
	define('VW_CONSTRUCTION_ESTATE_THEME_BUNDLE_BUY_NOW',__('https://www.vwthemes.com/products/wp-theme-bundle','vw-construction-estate'));
	define('VW_CONSTRUCTION_ESTATE_THEME_BUNDLE_DOC',__('https://preview.vwthemesdemo.com/docs/theme-bundle/','vw-construction-estate'));
	...
	if ( ! defined( 'VW_CONSTRUCTION_ESTATE_GO_PRO' ) ) {
		define( 'VW_CONSTRUCTION_ESTATE_GO_PRO', 'https://www.vwthemes.com/products/premium-construction-wordpress-theme');
	}
...
add_action( 'after_setup_theme', 'vw_construction_estate_init_setup' );	
            ...
            <?php if( get_theme_mod( 'vw_construction_estate_toggle_postdate',true) == 1 || get_theme_mod( 'vw_construction_estate_toggle_author',true) == 1 || get_theme_mod( 'vw_construction_estate_toggle_comments',true) == 1 || get_theme_mod( 'vw_construction_estate_toggle_time',true) == 1) { ?>
              <div class="metabox">
                <?php if(get_theme_mod('vw_construction_estate_toggle_postdate',true)==1){ ?>
                  <i class="fas fa-calendar-alt"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_construction_estate_archive_year, $vw_construction_estate_archive_month, $vw_construction_estate_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span><?php echo esc_html(get_theme_mod('vw_construction_estate_meta_field_separator','|'));?></span>
                <?php } ?>

                <?php if(get_theme_mod('vw_construction_estate_toggle_author',true)==1){ ?>
                  <i class="fas fa-user"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span><?php echo esc_html(get_theme_mod('vw_construction_estate_meta_field_separator','|'));?></span>
                <?php } ?>

                <?php if(get_theme_mod('vw_construction_estate_toggle_comments',true)==1){ ?>
                  <i class="fas fa-comments"></i><span class="entry-comments"><?php comments_number( __('0 Comments','vw-construction-estate'), __('0 Comments','vw-construction-estate'), __('% Comments','vw-construction-estate') ); ?></span><span><?php echo esc_html(get_theme_mod('vw_construction_estate_meta_field_separator','|'));?></span>
                <?php } ?>
